...
class CustomAdapter extends ArrayAdapter<DataObject> {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (dataObject.getSingleDate() != -9999l) {
            ...
            //        temp.setText(getCurrentSunsetSunrise(dataObject.getSingleSunrise(), dataObject.getSingleDate())+"\n"+dataObject.getSingleDate()*1000+"\n"+getCurrentSunsetSunrise(dataObject.getSingleSunset(), dataObject.getSingleDate()));
                }
            }
            ...
            if (icon_clothes_down != null) {
                ...
                if (dataObject.getSingleCloud() < 50) {
                    ...
                    if (dataObject.getSingleDate() * 1000 > (getCurrentSunsetSunrise(dataObject.getSingleSunrise(), dataObject.getSingleDate())) && dataObject.getSingleDate() * 1000 < (getCurrentSunsetSunrise(dataObject.getSingleSunset(), dataObject.getSingleDate()))) {
...
//        return nowDay+", "+forecastDay;
    ...
    public Long getCurrentSunsetSunrise(Long sunsetOrSunrise, Long currentDay) {
        ...
        int lastSunsetSunriseOfYear = Integer.parseInt(dayOfYear.format(lastSunsetSunrise));
        currentSusnetSunrise = (currentDayOfYear - lastSunsetSunriseOfYear) * TimeUnit.DAYS.toMillis(1) + sunsetOrSunrise * 1000;
